   ...
   /*      console.log(name,email,password,phone,address);
        ...
        try {
            ...
            if(res && res.data.success){
                ...
                localStorage.setItem('auth',JSON.stringify(res.data));   // this goes to auth.js where  getItem  and after refresh as well data remains 
                navigate(location.state || "/");                             // after success redirect to login page
            } 
            else{
